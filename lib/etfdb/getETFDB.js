...
import { convertToPercentage, trim } from '@/lib/commonFunction'
...
export const getETFDB = async ticker => {
  ...
  const etfResponse = !validTicker ? null : await getETFDbData(ticker)
  const soup = new JSSoup(etfResponse || { data: '' })

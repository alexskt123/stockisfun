...
async function getResponse(ticker) {
  ...
  try {
    ...
    console.log('Failed to execute lib/forecast/getStockFairValue - moneycnn')
  }
...
async function getWalletInvestorResponse(ticker, fundorstock) {
  ...
  try {
    ...
    console.log('Failed to execute lib/forecast/getStockFairValue - walletInvestor')
  }
...
async function getFinanchillResponse(ticker) {
  ...
  try {
    ...
    console.log('Failed to execute lib/forecast/getStockFairValue - financhill')
  }

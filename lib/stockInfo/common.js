...
const getRelativeStrengthByDays = async (ticker, refTicker, days) => {
  const fromToDate = getFormattedFromToDate(days, true)
  ...
  const rsValue = calRelativeStrength(
    tickerPrice[tickerPrice.length - 1 - days],
    tickerPrice[tickerPrice.length - 1],
    refPrice[refPrice.length - 1 - days],

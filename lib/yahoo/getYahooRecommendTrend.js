...
async function getResponse(ticker) {
  ...
  const response = validTicker && tickerType !== 'ETF' ? await axios(`https://query1.finance.yahoo.com/v10/finance/quoteSummary/${quote.ticker}?modules=recommendationTrend`).catch(console.error)
    : {}

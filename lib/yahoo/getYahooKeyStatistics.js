...
async function getResponse(ticker) {
  ...
  const [err, response] = validTicker && (tickerType === 'EQUITY' || tickerType === 'ETF') ? await to(axios(`https://query1.finance.yahoo.com/v10/finance/quoteSummary/${quote.ticker}?modules=defaultKeyStatistics`))
    : [null, {}]

...
import { getMultiQuote } from '@/lib/yahoo/getQuote'
...
export const getEarnings = inputData => {
  const earnings = {
    tableHeader: [],
    tableData: [],
    chartData: {
